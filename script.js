    ...
    pageProducts.forEach((product, index) => {
      ...
      cardDiv.innerHTML = `
        ...
        <div class="product-actions">
          <!-- Botão com símbolo de + para abrir o modal -->
...
function openAddToCartModal(productIndex) {
  ...
  // Monta o conteúdo do modal dinamicamente
...
/**
 * Lê a quantidade do modal e adiciona ao carrinho
 */
...
/**
 * Abre/fecha o painel do carrinho (modal grande)
 */
function toggleCart() {
